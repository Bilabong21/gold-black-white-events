      ...
      <section className="relative bg-secondary text-secondary-foreground py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-secondary-foreground/80 max-w-2xl mx-auto">
            BRCSA operates across Gauteng, North West, Free State and Northern Cape.
          </p>
        </div>
      </section>
            ...
            <div key={group.code}>
              ...
              {group.items.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {group.items.map((b) => (
                    <Card key={b.id} className="border-l-4 border-l-primary hover:shadow-lg transition-shadow">
